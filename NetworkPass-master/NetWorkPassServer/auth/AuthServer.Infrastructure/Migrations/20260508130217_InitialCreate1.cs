        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TFAStatus = table.Column<bool>(type: "bit", nullable: false),
                    TFACodeHash = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    PendingTFATokenHash = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    TFAExpiresDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    TFAIsCompleted = table.Column<bool>(type: "bit", nullable: false),
                    ResetPasswordTokenHash = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ResetPasswordTokenExpiresAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_PendingTFATokenHash",
                table: "Users",
                column: "PendingTFATokenHash",
                unique: true,
                filter: "[PendingTFATokenHash] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Users_ResetPasswordTokenHash",
                table: "Users",
                column: "ResetPasswordTokenHash",
                unique: true,
                filter: "[ResetPasswordTokenHash] IS NOT NULL");
